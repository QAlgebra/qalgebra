        ...
        for s in L.operands:
            ...
            if isinstance(term, SPre):
                ...
                if (
                    ...
                    or not (
                        isinstance(term.operands[0], SPre)
                        and isinstance(term.operands[1], SPost)
                    )
                ):
            ...
            for Lj in basis[ii:]:
                ...
                if cij != 0 or cji != 0:
                    ...
                    try:
                        ...
                        if diff.simplify():
                            print(
                                "Warning: the Liouvillian my be malformed, "
        ...
        if symbolic:
            ...
            ##                assert (kappa_12.conjugate() - kappa_21) == 0
                ...
                M = SympyMatrix(
                    len(basis),
                    len(basis),
                    lambda i, j: collapse_form[basis[i]][basis[j].adjoint()],
                )
                        ...
                        for evalue, multiplicity, ebasis in data:
                            ...
                            for b in ebasis:
                                new_L = (
                                    ...
                                    * sum(
                                        cj[0] * Lj
                                        for (cj, Lj) in zip(b.tolist(), basis)
                                    )
                                ).expand()
            ...
            M = np_array(
                [
                    [complex(collapse_form[Li][Lj.adjoint()]) for Lj in basis]
                    for Li in basis
                ]
            )
